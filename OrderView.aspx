<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderView.aspx.cs" Inherits="TheDenOrderingWebApp.OrderView" %>
...
<body class="bg-dark">
           ...
           <div class="control-group">
            ...
            <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                    ...
                    <input class="form-control" id="enteredPass" type="text" runat="server" placeholder="Enter Password" />
                    <p class="help-block text-danger"></p>
                </div>
            </div>
    ...
    <div class="card card-login mx-auto mt-5" style="width:90%; max-width:1200px;" id="buttons" runat="server" visible="false"> 
        ...
        <div class="container"> 
            ...
            <div runat="server" class="text-center m-auto" id="orderBTNs" visible="false" style="padding-top:25px">
                ...
                <a class="btn btn-primary btn-lg" id="outBoundOrdersbtn" runat="server" onserverclick="outBoundOrdersbtn_ServerClick">View Outbound Orders</a>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="container" runat="server" id="unCompleteOrders" visible="false" style="text-align:center">
        ...
        <div class="container" style="text-align:center; width:800px; margin:0 auto; align-content:center">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="OrderSpecialty" HeaderText="OrderSpecialty" />
                    ...
                    <asp:BoundField DataField="UserPhone" HeaderText="UserPhone" />
         ...
         <div class="control-group" style="padding-top:25px">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                    ...
                    <input class="form-control" id="inputUCtoWO" type="text" runat="server" placeholder="Enter ID you're working on" />
    ...
    <div class="container" runat="server" id="outboundOrders" visible="false" style="text-align:center">
        ...
        <label style="color:white;"> Outbound Orders </label>
            <div class="container" style="text-align:center; width:800px; margin:0 auto; align-content:center">
