<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="TheDenOrderingWebApp.Order" %>
...
<!--HEADER----------------------------------------------------------------------------------->
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger text-lowercase" href="#page-top">iDen  | </a>
        <button class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
          Menu
          <i class="fa fa-bars"></i>
        </button>
        <!-- Login -->
         <a class="navbar-brand js-scroll-trigger" runat="server" id="WelcomeLabel" visible="false"> Welcome </a>
        <button type="button" class="btn btn-primary btn-xl nav-link py-3 px-0 px-lg-3 masthead bg-secondary text-white text-center text-uppercase mb-0 border-0"  runat="server" id="LoginButtonMain" data-toggle="modal" data-target="#loginModal" >Login</button>
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">Deals</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <h1 class="text-uppercase mb-0">The Den Ordering App</h1>
        <hr class="star-light" />
        <h2 class="font-weight-light mb-0">Don't want to wait in line at The Den? Now you don't have to! Order your favorite drinks for a delivery or a pick-up!</h2>
      </div>
    </header>
<!--MENU----------------------------------------------------------------------------------->
    <!-- Menu Grid Section -->
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-1">
              ...
              <img class="img-fluid" src="TheDen/img/portfolioPics/TheBobcatDrink.png" alt="" />
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-2">
              ...
              <img class="img-fluid" src="TheDen/img/portfolioPics/BlackCoffee.png" alt="" />
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-3">
              ...
              <img class="img-fluid" src="TheDen/img/portfolioPics/Coffee.jpg" alt="" />
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-4">
              ...
              <img class="img-fluid" src="TheDen/img/portfolioPics/paper_cup_coffee.jpg" alt="" />
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
...
<!--DEALS----------------------------------------------------------------------------------->
    <!-- Deals Section -->
    <section class="bg-primary text-white mb-0" id="about" style="text-align:center">
      <div class="container">
        <h2 class="text-center text-uppercase text-white">Deals</h2>
        <hr class="star-light mb-5" />
        <div class="row">
            <div class="col-lg-4 ml-auto" style="align-content:center; width:800px auto; margin:0 auto">
                <p class="lead" runat="server" id="dealsText">Deals</p>
            </div>
        </div>
      </div>
    </section>
               ...
               <div class="control-group">
                  ...
                  <div class="control-group">
                      <div class="input-group mb-3">
                          ...
                          <select class="custom-select" id="pickUpTime" style="visibility:hidden" runat="server">
                              <option></option>
                              <option>11:25</option>
                              <option>11:40</option>
                          </select>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p class="lead mb-0">Follow our social media accounts to keep informed about The Den!</p>
            </div>
        </div>
      </div>
    </footer>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
             ...
             <div class="control-group">
              ...
              <!-- Link to Register -->
              <div class="container" style="padding-top:20px; padding-left:150px">
                  <label type="button" id="register" runat="server" data-target="#registerModal"> Don't Have An Account?</label>
              </div>
              <div class="container" style="padding-left: 200px; padding-bottom: 10px">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#registerModal">Register</button>
              </div>
              <div class="container" style="padding-left:182px">
                  <button type="button" class="btn btn-primary" id="btnForgotLogin" runat="server" onserverclick="btnForgotLogin_ServerClick">Forgot Login?</button>
              </div>
          </div>
            <!-- Login Footer -->
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" runat="server" onserverclick="loginClicked">Login</button>
          </div>
        </div>
      </div>
    </div>
<!--REGISTER----------------------------------------------------------------------------------->
            ...
            <!-- Confirm Password -->
             <div class="control-group">
              ...
              <div class="container" style="padding-top:20px">
                <label type="button" id="alreadyHaveAccount" runat="server"  data-toggel="modal">Already Have An Account? Click Here To Login</label>  <button type="button" class="btn btn-primary" data-dismiss="modal" data-target="#loginModal">Login</button>
              </div>
          </div>
              <!-- Register Footer -->
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" id="registerButton" runat="server" data-toggel="modal" data-target="#youareRegisteredModal" onserverclick="registerButton_ServerClick">Register</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function Total() {
            ...
            else if (orderItemSelected.value == "Italian Soda") {
                document.getElementById("totalLabel").innerText = totaltxt + "1.50"
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <hr class="star-dark mb-5" />
              <img class="img-fluid mb-5" src="TheDen/img/portfolioPics/TheBobcatDrink.png" alt="" />
              <p class="mb-5"> A great twist on the classic iced coffee. A nice blend of sweet cream, vanilla, and coffee to create The Den's signature drink. Cost: $2.50</p>
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <hr class="star-dark mb-5" />
              <img class="img-fluid mb-5" src="TheDen/img/portfolioPics/BlackCoffee.png" alt="" />
              <p class="mb-5">Using the Den’s signurature blend makes it the perfect pick me up, BUT ICED can be added with cream and/or flavored syrup! Cost: $2.00</p>
              <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="#">
                <i class="fa fa-close"></i>
                Close </a>
            </div>
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <hr class="star-dark mb-5" />
              <img class="img-fluid mb-5" src="TheDen/img/portfolio/circus.png" alt="" />
              <p class="mb-5"> Our go to cold day remedy, this rich chocolate drink is an all time student favorite. Cost: $1.75</p>
              <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="#">
                <i class="fa fa-close"></i>
                Close </a>
            </div>
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <hr class="star-dark mb-5" />
              <img class="img-fluid mb-5" src="TheDen/img/portfolio/game.png" alt="" />
              <p class="mb-5"> You can purchase the original lemonade or add a touch of strawberry or mango, or if you’re feeling adventurous combine the two!</p>
              <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="#">
                <i class="fa fa-close"></i>
                Close </a>
            </div>
    ...
    <div class="portfolio-modal mfp-hide" id="portfolio-modal-5">
      <div class="portfolio-modal-dialog bg-white">
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h2 class="text-secondary text-uppercase mb-0">Italian Soda</h2>
              <hr class="star-dark mb-5" />
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <hr class="star-dark mb-5" />
              <img class="img-fluid mb-5" src="TheDen/img/portfolio/submarine.png" alt="" />
